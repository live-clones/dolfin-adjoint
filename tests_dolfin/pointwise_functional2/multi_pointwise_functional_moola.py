...
def optimize():
    ...
    problem = MoolaOptimizationProblem(Jr)

    control = moola.DolfinPrimalVector(cl, inner_product="L2")  # Choose between l2, L2, H0_1 or H1

    solver = moola.BFGS(problem, control, options={'jtol': 0, 'gtol': 1e-10, 'maxiter': 10, 'mem_lim': 10})

    cl_opttt = solver.solve()['control'].data
